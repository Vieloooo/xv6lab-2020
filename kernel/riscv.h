...
#define PGROUNDUP(sz) (((sz) + PGSIZE - 1) & ~(PGSIZE - 1)) //get the upper addr of the page table
#define PGROUNDDOWN(a) (((a)) & ~(PGSIZE - 1))              //set low 11 bits to 0, get the bottom addr of the pgtbl
